...
public static void main(String[] args) {
  //Since the integer array is non static we need to create and object instance to use it in a static method.   
 ...
 //to using ArrayList. In ArrayList we need to iterate through each value and separate step needs to be 
 ...
 //Negatives: Backward compatibility is an issue as this functionality is available only in Java 8.
 ...
 //Positives:
 //Hash Set removes duplicates entry
 //Filtering of duplicates and populating new input array is taken care in 1 single for loop.
 //Negatives:
 //However, with this since we dont use an iterator to loop, this approach doesnt suite if we need to delete some elements in between
 //the processing.
